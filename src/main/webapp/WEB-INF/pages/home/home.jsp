...
%>
<title>..::${applicationScope.projectName}::.. | <spring:message code='home.title' /></title>
                ...
                <c:forEach var="candy" items="${candies}">
                    <div class="col-xs-6 col-sm-3 placeholder">
                        ...
                        <div style="margin: 5px 0px 15px;">
                            ...
                            <span class="text-muted">类别:${candy.candyCategory.candyCategoryName}&nbsp;|&nbsp;销<spring:message code='home.amount' />:${candy.salesVolume}</span>
                        </div>
                    </div>
                </c:forEach>
            </div><!--/row-->
