...
<head>
    ...
    <meta name="description" content="Naphel Bidding System">
    <meta name="author" content="Naphel Bidding System">
    <link rel="icon" href="<%=basePath%>resources/img/fav2.ico">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title">
                    <spring:message code='publiclay.modaltitle' />
                </h5>
            </div>
